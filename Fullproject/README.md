...
For frontend-specific information see [frontend/README.md](frontend/README.md). If you'd like, I can:

- Add example `.env` files for dev and production.
- Expand `Backend/README.md` with detailed backend setup and API docs.

Thank you — tell me which follow-up you want next.
